...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://minute-calc-engine.preview.emergentagent.com").rstrip("/")
API = f"{BASE_URL}/api"
...
class TestSignatureRequest:
    ...
    def test_request_signature_via_email(self, auth_headers):
        payload = {
            ...
            "origin_url": "https://minute-calc-engine.preview.emergentagent.com",
