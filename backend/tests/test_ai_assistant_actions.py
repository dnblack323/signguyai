...
class MockUser:
    ...
    def __init__(self, role=UserRole.OWNER, tenant_id="test_tenant"):
        self.id = "test_user"
...
class TestTenantScoping:
    ...
    async def test_cannot_update_other_tenant_job(self, mock_db):
        ...
        actions = AIAssistantActions(mock_db)
        user = MockUser(role=UserRole.OWNER, tenant_id="tenant_a")
...
class TestAuditLogging:
    ...
    async def test_successful_action_logged(self, mock_db):
        ...
        actions = AIAssistantActions(mock_db)
        user = MockUser(role=UserRole.OWNER, tenant_id="test_tenant")
