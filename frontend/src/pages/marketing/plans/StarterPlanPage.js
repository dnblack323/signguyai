        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/30 rounded-full mb-6">
              ...
              <span className="text-blue-400 text-sm font-medium">OS Plan</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Starter</h1>
            <p className="text-xl text-gray-400 mb-6">Perfect for solo sign makers getting started</p>
            <div className="mb-8">
              <span className="text-5xl font-bold">$29</span>
              <span className="text-gray-400 text-xl">/mo</span>
              <p className="text-amber-400 mt-2">Founder pricing (reg. $39/mo)</p>
            </div>
            <Link to="/login">
