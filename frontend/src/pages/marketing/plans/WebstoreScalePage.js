...
export default function WebstoreScalePage() {
  const features = [
    'Unlimited Webstores',
    'Advanced Analytics',
    'Bulk Order Tools',
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Scale</h1>
            <p className="text-xl text-gray-400 mb-6">Unlimited webstores for high-volume shops</p>
            <div className="mb-8">
