  ...
  return (
    <div className="space-y-6 animate-fade-in" data-testid="quotes-page">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold font-heading uppercase tracking-tight text-white">Quotes</h1>
          <p className="text-slate-300 mt-1">{quotes.length} total quotes</p>
        </div>
