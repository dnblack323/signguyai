...
Run:
  export REACT_APP_BACKEND_URL=https://sms-invoices.preview.emergentagent.com
...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://sms-invoices.preview.emergentagent.com")
