...
Run:
  export REACT_APP_BACKEND_URL=https://sms-consent-demo.preview.emergentagent.com
...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://sms-consent-demo.preview.emergentagent.com")
