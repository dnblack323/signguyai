...
Run:
  export REACT_APP_BACKEND_URL=https://guided-onboarding-1.preview.emergentagent.com
...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://guided-onboarding-1.preview.emergentagent.com")
