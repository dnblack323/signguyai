...
> **Preview URL pattern:** `https://sign-production-hub-1.preview.emergentagent.com` (read actual value from `REACT_APP_BACKEND_URL`)
>
...
- [x] Toggle **Lamination = Yes** → price jumps by the lamination rate
